-- Add downloadable_documents field to tasks table
ALTER TABLE tasks ADD COLUMN downloadable_documents TEXT[];

-- Update the create_demo_case_for_user function to include downloadable documents
...
BEGIN
  ...
  INSERT INTO public.tasks (case_id, stage, title, description, status, order_index, required_documents, downloadable_documents) VALUES
    ...
    (new_case_id, 'STAGE_1', 'Client Information Form', 
     ...
     ARRAY['Client_Information_Form.pdf']),
